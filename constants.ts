...
export const DGR_CHAPTERS: DGRChapter[] = [
  {
    ...
    sections: [
        ...
        { id: "1.3.1", title: "Responsabilidades do Expedidor", blocks: [{ type: "paragraph", content: "O expedidor (shipper) é a principal parte responsável por garantir que as mercadorias perigosas sejam oferecidas para transporte em total conformidade com estes regulamentos. Esta responsabilidade não pode ser delegada."}] },
  ...
  },
  {
    ...
    sections: [
        ...
        { id: "2.6", title: "Quantidades Excecionadas (EQ)", blocks: [{ type: "paragraph", content: "Pequenas quantidades de certas mercadorias perigosas podem ser transportadas com requisitos regulatórios bastante reduzidos. A coluna F da Tabela 4.2 indica o código EQ aplicável." }, { type: "visual-mark", content: { type: 'eq', data: {class: '3', unNumbers: '1263'}, caption: "Marca de Quantidade Excecionada" } }] },
  ...
  },
  {
    ...
    icon: FlaskConical,
    sections: [
        { id: "3.0", title: "Responsabilidade pela Classificação", blocks: [{ type: "paragraph", content: "O expedidor é responsável por classificar corretamente as mercadorias perigosas." }] },
        ...
        { id: "3.1.1", title: "Divisões", blocks:[{ type: "paragraph", content: "Detalha as 6 divisões da Classe 1 (1.1 a 1.6)." }] }, 
        { id: "3.1.2", title: "Grupos de Compatibilidade", blocks:[{ type: "paragraph", content: "Explica os grupos de compatibilidade (letras A-S) que indicam quais tipos de explosivos podem ser transportados juntos." }] },
        { id: "3.2", title: "Classe 2 - Gases", blocks: [{ type: "paragraph", content: "Divisão 2.1 (Inflamável), 2.2 (Não-Inflamável, Não-Tóxico), 2.3 (Tóxico)." }] },
        { id: "3.2.1", title: "Divisão 2.1 – Gases Inflamáveis", blocks:[{ type: "paragraph", content: "Gases que a 20°C e 101.3 kPa são inflamáveis em mistura de 13% ou menos por volume com ar." }] }, 
        ...
        { id: "3.2.3", title: "Divisão 2.3 – Gases Tóxicos", blocks:[{ type: "paragraph", content: "Gases que são conhecidos por serem tóxicos ou corrosivos para humanos a ponto de representar um risco à saúde durante o transporte." }] },
        { id: "3.3", title: "Classe 3 - Líquidos Inflamáveis", blocks: [{ type: "paragraph", content: "Líquidos com ponto de fulgor igual ou inferior a 60°C." }] },
        { id: "3.3.1", title: "Determinação do Ponto de Fulgor", blocks:[{ type: "paragraph", content: "Explica os métodos de teste de vaso fechado para determinar o ponto de fulgor." }] }, 
        { id: "3.3.2", title: "Determinação do Grupo de Embalagem", blocks:[{ type: "paragraph", content: "O Grupo de Embalagem para Classe 3 é determinado pela combinação do ponto de fulgor e do ponto de ebulição inicial." }] },
        ...
        { id: "3.7", title: "Classe 7 - Material Radioativo", blocks: [{ type: "paragraph", content: "Materiais contendo radionuclídeos cuja atividade excede os valores especificados." }] },
        { id: "3.8", title: "Classe 8 - Corrosivos", blocks: [{ type: "paragraph", content: "Substâncias que causam destruição severa por ação química em tecidos vivos ou metais." }] },
        { id: "3.9", title: "Classe 9 - Miscelâneas", blocks: [{ type: "paragraph", content: "Perigos não cobertos por outras classes." }] },
        { id: "3.9.1", title: "Geral", blocks: [{ type: "paragraph", content: "Esta classe abrange substâncias e artigos que, durante o transporte aéreo, apresentam um perigo não coberto por outras classes." }] },
        { id: "3.9.2", title: "Baterias de Lítio", blocks: [{ type: "paragraph", content: "Regulamentações específicas para o transporte de baterias de lítio metálico (UN 3090, UN 3091) e de íon lítio (UN 3480, UN 3481)." }] },
        { id: "3.9.3", title: "Material Magnetizado", blocks: [{ type: "paragraph", content: "Artigos que possuem campos magnéticos fortes o suficiente para afetar os sistemas de navegação da aeronave." }] },
  ...
  },
  {
    ...
    sections: [
        ...
        { id: "5.0.2", title: "Requisitos Gerais de Embalagem", blocks:[{ type: "paragraph", content: "Define os requisitos fundamentais para todas as embalagens, como qualidade, compatibilidade com o conteúdo e resistência a mudanças de pressão e temperatura."}]},
        ...
        { id: "5.1", title: "Instruções de Embalagem - Classe 1", blocks: [{ type: "paragraph", content: "Contém as Instruções de Embalagem de 101 a 143." }] },
        { id: "5.2", title: "Instruções de Embalagem - Classe 2", blocks: [{ type: "paragraph", content: "Contém as Instruções de Embalagem de 200 a 222." }] },
        { id: "5.3", title: "Instruções de Embalagem - Classe 3", blocks: [{ type: "paragraph", content: "Contém as Instruções de Embalagem de 340 a 378." }] },
        { id: "5.4", title: "Instruções de Embalagem - Classe 4", blocks: [{ type: "paragraph", content: "Contém as Instruções de Embalagem de 440 a 492." }] },
        { id: "5.5", title: "Instruções de Embalagem - Classe 5", blocks: [{ type: "paragraph", content: "Contém as Instruções de Embalagem de 520 a 572." }] },
        { id: "5.6", title: "Instruções de Embalagem - Classe 6", blocks: [{ type: "paragraph", content: "Contém as Instruções de Embalagem de 620 a 682." }] },
        { id: "5.7", title: "Instruções de Embalagem - Classe 8", blocks: [{ type: "paragraph", content: "Contém as Instruções de Embalagem de 850 a 872." }] },
        { id: "5.8", title: "Instruções de Embalagem - Classe 9", blocks: [{ type: "paragraph", content: "Contém as Instruções de Embalagem de 950 a 970." }] },
    ]
  },
  {
      id: 6,
  ...
  },
  {
      ...
      sections: [
          ...
          { id: "7.1", title: "Marcação", blocks: [{ type: "paragraph", content: "Cada volume contendo mercadorias perigosas deve ser marcado de forma durável e legível com informações essenciais." }] },
          ...
          { id: "7.2.3", title: "Posicionamento das Etiquetas", blocks:[{ type: "paragraph", content: "As etiquetas devem ser afixadas em uma superfície do volume, perto da marca do Nome Apropriado." }]},
  ...
  },
  {
      ...
      sections: [
          ...
          { id: "8.1.1", title: "Preenchimento", blocks:[{ type: "paragraph", content: "A DGD deve ser preenchida de forma precisa e completa, sem rasuras não autorizadas." }] },
  ...
  },
  {
      ...
      icon: Plane,
      sections: [
          { id: "9.1", title: "Aceitação", blocks: [ { type: "paragraph", content: "O operador deve usar um checklist de aceitação para verificar a conformidade de cada remessa." } ] },
          ...
          { id: "9.1.2", title: "Recusa de Carga", blocks:[{ type: "paragraph", content: "Remessas que não cumprem os regulamentos devem ser recusadas e o expedidor notificado." }] },
          ...
          { id: "9.3.1", title: "Tabela de Segregação", blocks:[{ type: "paragraph", content: "A Tabela 9.3.A detalha os requisitos de segregação entre diferentes classes de mercadorias perigosas." }] }, 
          { id: "9.3.2", title: "Segregação de Radioativos", blocks:[{ type: "paragraph", content: "Material radioativo deve ser segregado de pessoas, animais vivos e filme fotográfico não revelado." }] },
          ...
          { id: "9.5", title: "Informação ao Piloto em Comando (NOTOC)", blocks: [{ type: "paragraph", content: "O piloto deve ser notificado por escrito (NOTOC) sobre as mercadorias perigosas a bordo, sua localização e quantidade." }] },
